...
angular.module('PulseTotemManagerCMS')
  .controller('PulseTotemManagerCMS.Photos.PhotosListCtrl', ['$rootScope', '$scope', '$routeParams', '$timeout', 'CONSTANTS', 'PhotosCollection', 'Photo', '$mdDialog', '$mdMedia', 'manageCurrentState', function($rootScope, $scope, $routeParams, $timeout, CONSTANTS, PhotosCollection, Photo, $mdDialog, $mdMedia, manageCurrentState){
